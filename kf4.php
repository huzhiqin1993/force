...
foreach($data1 as $row1) {
        ...
        $arrIPaddress1 = $row1[$coltwo]; //子节点名字
		      ...
		      $Name1 = $row1['Name'];
			    ...
			    $Name1=iconv('gb2312', 'utf-8', $Name1);
				
				
				$CtfId1 = $row1['CtfId']; //父节点名字
				
				$Gender1= $row1['Gender']; //子节点名字
				
					
				$Birthday1= $row1['Birthday']; 
			
				     $Address1= $row1['Address'];
				$Address1=iconv('gb2312', 'utf-8', $Address1);
      ...
      //  if (!in_array('{"name":"'.$arrIPaddress1.'","group":1,"size":60,"image":"1.png","rank":"1","parent":"1","id":"c11"}', $node)) {
		  ...
		  if ($p++==0) {
                //$node[]= '{"name":"'.$arrTarget1.'","group":1,"size":300,"regit":"'.$regit.'","seal":"'.$seal.'","validity":"'.$validity.'","agency":"'.$agency.'"}';  
                $node[] = '{"name":"'.$arrIPaddress1.'","group":1,"age":"'.$CtfId1.'","image":"qq.png","type":"qq","gender":"'.$Gender1.'","birthday":"'.$Birthday1.'","address":"'.$Address1.'","mobile":"'.$Mobile1.'" }';
                $arry[] = $arrTarget1; ////
...
//                        echo "<br>";
				...
				$CtfId2= $row2['CtfId']; //父节点名字
				
		$Gender2= $row2['Gender']; //子节点名字
		...
		$Nick2= $row2['Version']; 
				...
				$Address=iconv('gb2312', 'utf-8', $Address);
				$Mobile= $row2['Mobile']; 
...
file_put_contents("force.json", $json); //数据写入到force.json文件中 
